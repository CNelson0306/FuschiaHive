...
function Hair() {
  return (
    <>
      <div className="hair-display">
        <h1 className="hair-header">Hair</h1>
        ...
        <section id="hair" className="hairContainerCombined">
          ...
          <div className="hairTreatmentCombined">
            <span>All colour services include full olaplex treatment</span>
            <p></p>
            <p></p>
          </div>
          ...
          <div className="hairTreatmentCombined">
            <span>Hair extensions by quotation</span>
            <p></p>
            <p></p>
          </div>
