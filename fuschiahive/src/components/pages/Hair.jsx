...
function Hair(){
  return (
    ...
    <section id='hair' className='hairContainer'>
      <h1 className='sectionTitle'>Hair</h1>
      ...
      <div className='hairTreatment'>
        <span>festival hair / coloured braids</span>
          <p>£30</p>
      </div>
      <br />
      <hr />
    ...
    <section id='hair' className='hairContainerCombined'>
      <div className='combinedTreatment'>
        <h6></h6>
        <h6>fine/short</h6>
        <h6>thick/long</h6>
      </div>
      ...
      <br />
      <div className='hairTreatmentCombined'>
        <span>All colour services include
      ...
      <br />
      <div className='hairTreatmentCombined'>
        <span>Hair extensions by quotation
        </span>
        <p></p>
        <p></p>
      </div>
      ...
      <br />
      <div className='hairTreatmentCombined'>
        <span>Hair extension removal including
          a treatment, cut & blowdry (hourly)
        </span>
        <p>£60</p>
        <p>£60</p>
      </div>
